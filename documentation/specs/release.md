...
- **Two sessions starting at once** both activate, and install's lock serialises them. The second finds the release already live and reports it as its own session's change, which it is.
